...
export type PhotosConsentProps = {}

export default function PhotosConsent({}: PhotosConsentProps) {
        ...
        <div className='grid gap-3'>
          <div className='flex gap-2 items-center'>
            <input
              id='no'
              type='radio'
              name='photos-permission'
              className='radio'
              value={0}
              onChange={(e) =>
                setMaleData({
                  photosConsent: Boolean(parseInt(e.target.value)),
                })
              }
            />
